 (function($,window,document,undefined) {    
    ...
    playingCards.card.prototype.getHTML = function() {
        ...
        var strBuild = ['<div class="playingCard" data-color=',this.suit,' data-value=',oldRank,'><div class="front ', this.colorCls, '"><div class="corner">', txt, '<br />', this.suitCode, '</div>'];
    ...
    playingCards.card.prototype.buildIconHTML = function() {
        ...
        if (this.rank === "J" || this.rank === "Q" || this.rank === "K" || this.rank === "N") {
            var n = 'D';
            var imgPrefix = "/Component/Playing-cards/";
